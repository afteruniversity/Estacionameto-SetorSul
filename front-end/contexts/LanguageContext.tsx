...
const dictionaries: Record<Language, Translations> = {
    "pt-BR": {
        ...
        hero: {
            ...
            subtitle: "Segurança, praticidade e controle total para sua vaga. Mensalistas e rotativos com a melhor experiência.",
            cta: "Garanta sua vaga"
        },
        about: {
            badge: "Sobre o Projeto",
            title: "Modernizando o estacionamento do Setor Sul",
            description: "Nosso sistema visa otimizar o uso das vagas limitadas, oferecendo uma gestão transparente e eficiente tanto para mensalistas quanto para usuários avulsos.",
        ...
        plans: {
            offer: {
                ...
                description: "Selecione os dias da semana que você precisa de acesso ao estacionamento",
            },
            summary: {
            ...
            active: {
                ...
                pageDesc: "Gerencie sua assinatura e dias de acesso ao estacionamento de forma simples e prática.",
                simulateLabel: "Simular",
                simulateWith: "Com Plano",
                simulateWithout: "Sem Plano",
                statusTitle: "Plano Ativo",
                statusDesc: "Você tem acesso garantido ao estacionamento nos dias selecionados",
                ...
                cancelAlert: {
                    ...
                    description: "Tem certeza que deseja cancelar seu plano? Você perderá o acesso aos dias reservados e esta ação não poderá ser desfeita.",
                    back: "Voltar",
        ...
        footer: {
            copyright: "© 2024 Estacionamento Setor Sul. Todos os direitos reservados."
        },
        common: {
            days: {
    ...
    "en": {
        ...
        hero: {
            ...
            subtitle: "Secure, practical and well located in the South Sector. The best option for your vehicle.",
            cta: "Secure your spot"
        },
        about: {
            badge: "About the Project",
            title: "About the Project",
            description: "Setor Sul Parking was born from the need to optimize urban space usage in one of the city's busiest regions. Our mission is to offer security, practicality, and fair prices for monthly and daily users.",
        ...
        plans: {
            ...
            active: {
                ...
                pageDesc: "Manage your subscription and parking access days simply and practically.",
                ...
                cancelAlert: {
                    title: "Cancel Plan",
                    description: "Are you sure you want to cancel your plan? You will lose access to reserved days and this action cannot be undone.",
                    back: "Back",
    ...
    "es": {
        ...
        hero: {
            ...
            subtitle: "Seguro, práctico y bien ubicado en el Sector Sur. La mejor opción para su vehículo.",
            cta: "Asegura tu lugar"
        },
        about: {
            badge: "Sobre el Proyecto",
            title: "Sobre el Proyecto",
            description: "El Estacionamiento Sector Sur nació de la necesidad de optimizar el uso de espacios urbanos en una de las regiones más concurridas de la ciudad. Nuestra misión es ofrecer seguridad, practicidad y precios justos para mensualistas y rotativos.",
        ...
        plans: {
            offer: {
                title: "Elige tu Plan",
                description: "Seleccione los días de la semana que necesita acceso al estacionamiento",
            },
            summary: {
            ...
            active: {
                ...
                pageDesc: "Administre su suscripción y días de acceso al estacionamiento de forma sencilla y práctica.",
                simulateLabel: "Simular",
                simulateWith: "Con Plan",
                simulateWithout: "Sin Plan",
                statusTitle: "Plan Activo",
                statusDesc: "Tiene acceso garantizado al estacionamiento en los días seleccionados",
                ...
                cancelAlert: {
                    title: "Cancelar Plan",
                    description: "¿Está seguro de que desea cancelar su plan? Perderá el acceso a los días reservados y esta acción no se puede deshacer.",
                    back: "Volver",
        ...
        footer: {
            copyright: "© 2024 Estacionamento Setor Sul. Todos los derechos reservados."
        },
        common: {
            days: {
