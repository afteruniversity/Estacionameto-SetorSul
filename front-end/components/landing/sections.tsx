...
export function PricingSection() {
  ...
  return (
    <section
      id="pricing"
      className="w-full py-12 md:py-24 lg:py-32 bg-[linear-gradient(to_right,#adeada,#bdeadb,#cdeadc,#ddeadd,#edeade)] dark:bg-[linear-gradient(to_right,#022c22,#064e3b,#065f46,#115e59)]"
    >
      <div className="container mx-auto px-4 md:px-6">
        <div className="flex flex-col items-center justify-center space-y-4 text-center">
          <div className="space-y-2">
            <div className="inline-block rounded-lg bg-background/50 border px-3 py-1 text-sm backdrop-blur-sm text-foreground">
              {t("pricing.simulation")}
            </div>
            <h2 className="text-3xl font-bold tracking-tighter sm:text-5xl text-emerald-950 dark:text-emerald-50">
              {t("pricing.title")}
            </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-12 max-w-4xl mx-auto">
          ...
          <Card className="flex flex-col bg-white/80 dark:bg-black/40 border-emerald-100 dark:border-emerald-900 shadow-lg">
            ...
            <CardFooter>
              ...
              <Link
                href="/auth"
                className={`w-full ${
                  daysCount === 0 ? "pointer-events-none" : ""
                }`}
              >
                <Button
          ...
          <Card className="flex flex-col relative border-emerald-500 shadow-xl bg-white dark:bg-emerald-950/30 scale-105 z-10 dark:border-emerald-600">
            ...
            <CardHeader>
              <CardTitle className="dark:text-emerald-50">
                {t("pricing.monthlyPlan")}
              </CardTitle>
              <CardDescription className="dark:text-emerald-200/60">
                {t("pricing.monthlyPlanDesc")}
              </CardDescription>
            </CardHeader>
            <CardContent className="flex-1">
              <div className="flex flex-col">
